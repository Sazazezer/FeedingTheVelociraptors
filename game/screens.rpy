                ...
                if renpy.variant("pc"):
                    ...
                    vbox:
                        ...
                        textbutton "VT323":
                            ...
                            text_size 24
                            action [StylePreference("text", "VT323"),Function(style.rebuild)]
                        textbutton "Source Sans Pro":
                            text_font "SourceSansPro-Regular.ttf"
                            text_size 20
                            action [StylePreference("text", "Sans Serif"),Function(style.rebuild)]
                    vbox:
                        style_prefix "radio"
                        label _("Language")
                        textbutton "English":
                        ...
                        textbutton "Español":
                            text_font "VT323-Regular.ttf"
                            text_size 24
                            action [Language("spanish"),StylePreference("text", "VT323"),Function(style.rebuild)]
...
screen keyboard_help():
    ...
    hbox:
        label _("Space")
        text _("Advances dialogue without activating interface.")
    ...
    hbox:
        label _("Ctrl")
        text _("Skips previously read dialogue while held down.")
    ...
    hbox:
        label "A"
        text _("Opens accessibility override menu.")
...
screen checklist():
    ...
    use game_menu(_("Checklist"), scroll="viewport"):

        vbox:
            text _("List of Endings Completed") size 20
...
screen skip_indicator():
    ...
    frame:
        ...
        hbox:
            ...
            text _("Skipping") outlines [(2,'#000',0,0)]
...
screen notify(message):
    ...
    frame at notify_appear:
        ypos 10
        text "[message!tq]" size 16 outlines [(4,'#000',0,0)]
