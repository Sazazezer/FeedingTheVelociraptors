...
label route01: #accussing adrian - Evidence -  print out and personal photo / Stuff - Crowbar - Find Crowbar in toilets. USe it to break open Locker. Both items are found in Reception
    ...
    t tsurprised "I honestly wold have thought we would have to come get you."
    ...
    h hstern "Oh nonsense. If the place finds a way to continue, you definitely have to bring him over. Hes so sweet."
    a ablush "Oh. Thanks."
    t tempty "And all this time i could have sworn you were- well, nevermind."
    p pshocked "Erm-"
    a asmile "Well i'm sure i must have mentioned them..."
    t tupset "Well, i suppose it sounds foolish, but i’m usually ina  bit of a rush when coming into reception, so i’ve probably-"
    ...
    t tsmile "I know a great place. They have their own michilena star chef. Does incredibly !!food!!"
...
label route02: # Accussing Jenny - Evidence - Grenade - Dictaphone/Transcript / Stuff - Match/ some other firestarter - Grenade found in Security Room - Dictaphone found in JEnny's Bunk box, accessible by start a fire in the bunks, with match and fuel can. Match found in CEO Office, Fuel can found in Corridor.
    ...
    j jmad "The hell?"
    p phappy "Jenny’s crimes are most unconsciousable, and it would do you all well to heed and words and take action from them."
...
label route03: # Accussing Helen - Evidence - Research Journal/Raptor Claw / Stuff - Research Journal found under chair in Lab (staff room) - Raptor Claw found by using security card on containment lock. Card found in CEO office
    ...
    p phappy "That couldn’t count."
    j jmad "The hell you say!"
    p phappy "Anyway, I bring to you, in this most dire fo times, evidence. "
    ...
    p pevasive "That was the whole premise of this entire escapade."
    ...
    p phappy "All in the hopes of saving myself. A person who may nto be worthy of being saved."
    ...
    j j shocked "What’s this?"
    a ahorrified "Huh? These appear to be research notes on the the Velociraptor Reproduction Analysis. "
    ...
    h hstern "Exactly. Our CEO found my research papers. He cotton onto it."
    ...
    j jshocked "Yeah i guess because it looks like you have the cushy science job that you’re getting by just fine."
    ...
    t tsmile "Hey, why don;t we go there now?"
...
label route04: # Accussing Tony - Evidence - Assassin Contract/Wad of Cash / Stuff - Hammer Wad of cash found in Tony's bunk. Contract found in CEO office globe by smashing globe with hammer. HAmmer found under teddy bear in bunks
    ...
    t tsmile "Hey, ti’s nothing to get blown up into little pieces about."
    ...
    h hstern "...of the target of the contract life ends within the agreed upon date range..."
    t tupset "Erm..."
    ...
    t tsmile "Didn’t you Paul? I wouldn’t want you to trip over such a simple mistake and get yourself hurt."
    a asad "..."
    h hstern "..."
    j jshocked ".."
    ...
    t tangry "Again. Not thast any of itmatters."
    ...
    h hstern "So this doesn’t really cange anything fo us."
    ...
    t tupset "And you’re looking very mch like an obstruction, boy."
    p pstoic "..."
...
label route05: # faking evidence to accuse Adrian - Evidence - Fake Transcript/ Fake ID card / Stuff - Plain paper/ Plain ID card - Plain paper found in reception, ID found in Lab, security puzzle completed in security room
    ...
    p phappy "For he is te one who attempted to hide this evidence, and i am the one who attempted to find it."
    p phappy "And er... did."
    ...
    p phappy "I printed it off as a pdf, then copied it to word to print out."
    ...
    p phappy "It’s nice to know things work out well in the end."
    p phappy "You clock in everyday. You work hard."
    p phappy "You get noticed by your boss and you’re appreciated for your efforts."
    p phappy "Life goes by nicely. "
    p phappy "Sure i’ll have to get a new job now."
    p phappy "And i don’t have anyone left to give me a reference from my old job."
    p phappy "But it’s sure to make an interesting story in the next interview."
    p phappy "All it requires is a way to bring it up organically."
    p phappy "Oh, i could also mention i got to ride on a helicopter."
    p phappy "That’ll make me stand out."
    p phappy "Yep. Sure is a good day."
    #!!fixforspecialending
    $ location = 10
    jump investistart
    #!!removeaftertesting
